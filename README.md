...
##  Requirements
 ...
 - The real images used in this work come from the paper "A Bias-Free Training Paradigm for More General AI-generated Image Detection"[^6], and can be found [here](https://www.grip.unina.it/download/prog/B-Free/training_data/).

 [^6]: Fabrizio Guillaro, Giada Zingarini, Ben Usman,
Avneesh Sud, Davide Cozzolino, and Luisa Verdoliva,
“A bias-free training paradigm for more general ai-
generated image detection,” *in Proc. of the Computer
...
- Attribution: You must give the appropriate credit, provide a link to the license, and indicate changes.
